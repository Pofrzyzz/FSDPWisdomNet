      ...
      {isChatOpen ? (
        <div className="bg-white shadow-lg rounded-lg" style={{ width: '375px', height: '578px' }}>
          ...
          <div className="p-4 flex flex-col h-full justify-between">
            {isLoading ? (
              <div className="flex items-center justify-center h-full text-gray-700 text-lg font-semibold">
                <p>Loading...</p>
              </div>
            ) : step === 2 ? (
              <div>
        ...
        <button className="bg-[#DA291C] text-white p-4 rounded-full shadow-lg hover:bg-[#C00E1A]" onClick={() => setIsChatOpen(true)}>
